  ...
  >
    Saiba mais
      ...
      <Box sx={{ px: 2, py: 2, textAlign: "center" }}>
        <Typography variant="h6" fontWeight="bold" sx={{ background: "linear-gradient(to right, #4703FB, #57B7EF)", borderRadius: "30px", px: 9, py: 1, color: "white", display: "inline-block", mb: 6 }}>
          Como funciona?
        </Typography>

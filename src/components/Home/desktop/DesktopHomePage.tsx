...
const DesktopHomePage: React.FC = () => {
  return (
    <Box sx={{ display: { xs: "none", md: "block" }, background: "linear-gradient(180deg, #000C1E 100%, #000C1E 100%)", color: "white" }}>
      ...
      <Box component="section" sx={{ position: "relative", width: "100%", minHeight: { md: "620px", lg: "720px" }, overflow: "hidden", fontFamily: "Montserrat, sans-serif" }}>
        ...
        {/* Conteúdo */}
        <Box sx={{ position: "relative", zIndex: 2, maxWidth: 1280, mx: "auto", px: { md: 8, lg: 12 }, height: "100%", display: "flex", alignItems: "center", gap: 6 }}>
          {/* Coluna esquerda */}
...
>
  ...
  <Box sx={{ position: "relative", zIndex: 1 }}>
    ...
    <Box sx={{ maxWidth: 800, mx: "auto", textAlign: "left" }}>
     <Typography
  variant="h5"
  sx={{ color: "rgba(255,255,255,0.88)", lineHeight: 1.5, textAlign: "left" }}
>
  ...
  <Box component="span" sx={{ fontStyle: "italic", fontWeight: "bold" }}>
    ...
    {/* Bloco 3: Texto final centralizado */}
...
<Box sx={{ textAlign: "center", py: 10, position: "relative" }}>
  <Typography variant="h4" fontWeight="bold" mb={6} sx={{ color: "white" }} >Como funciona?</Typography>
...
<Box
  sx={{
    ...
    py: 8,
    color: "white",
    overflow: "hidden", // para esconder o que passar do container
    backgroundColor: "#000C1E", // fundo azul escuro igual na referência
  }}
>
  {/* Ícone de fundo */}
  <Box
    sx={{
      ...
      width: { xs: "120%", md: "70%" },
      height: "auto",
      opacity: 1, // deixa suave no fundo
      zIndex: 0,
    }}
  >
    <Image
  ...
  <Box sx={{ position: "relative", zIndex: 1 }}>
    ...
    <Typography
      variant="h5"
      fontWeight="bold"
      sx={{ color: "#FFFFFF", fontStyle: "italic", mb: 4, textAlign: "left" }}
    >
      Resultados que fazem a diferença!
    </Typography>


    {/* Imagem medicos-02 colada à lateral direita, grande */}
<Box
  sx={{
    position: "relative",
    width: "100%",
    height: { md: "300px", lg: "550px" }, // altura grande para ampliar a imagem
    mt: 4,
    mb: 8,
    overflow: "visible",
    display: "flex",
    justifyContent: "flex-end", // cola na direita
    alignItems: "flex-end",     // alinha base da imagem com o container
  }}
>
  <Image
    src="/medicos-02.png"
    alt="Equipe médica adicional"
    width={800} // largura grande (aprox 3x)
    height={1000} // altura proporcional
    style={{
      width: "auto",
      height: "100%",
      objectFit: "contain",
...
>
  ...
  <Box textAlign="center" p={2}>
    ...
    <Typography variant="body1" sx={{ color: "white" }}>
      de economia no orçamento da saúde
    </Typography>
  </Box>
  ...
  <Box textAlign="center" p={2}>
    ...
    <Box textAlign="center" sx={{ mt: 6 }}>
     ...
     {/* CTA IMAGE */}
<Box sx={{ position: "relative", py: 8, bgcolor: "#000C1E" }}>
  {/* Fundo gradiente ocupando toda a largura */}
  ...
  {/* Conteúdo central com link para WhatsApp */}
  <a
    href="https://wa.me/554788992915"
    target="_blank"
    rel="noopener noreferrer"
  ...
  >
    <Box
      sx={{
        ...
        cursor: "pointer",
        zIndex: 2,
        transform: "scale(0.7)", // reduz 30%
        transformOrigin: "center center", // centraliza o scale
      }}
    >
      {/* Imagem do médico */}
      <Image
      ...
      >
        <Typography
          ...
          sx={{ lineHeight: 1.4 }}
        >
          Clique aqui e agende já uma reunião com nosso time!
        </Typography>
      </Box>
    </Box>
  </a>
...
>
  ...
  {/* Caixa verde de contato + redes sociais */}
  <Box
    sx={{
